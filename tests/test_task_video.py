...
class Test_calculate_Naive_Bayes(unittest.TestCase):
    def setUp(self):
        ...
        self.train_targets  = pd.read_csv(os.path.join(folder_path4,"NATICUSdroid_train_targets.csv"), index_col=0)
        self.test_targets   = pd.read_csv(os.path.join(folder_path4,"NATICUSdroid_test_targets.csv"), index_col=0)
